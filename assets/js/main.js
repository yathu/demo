$(document).ready(function () {
    ...
    $('.subTotalValue').text(totalprice.toFixed(2));

    if ($('section').hasClass('addons')) {
        //
        $('input:checkbox').change(
            function () {
                var thisPrice = $(this).data('price');
                var checkedBtn = $(this).data('btn');
                ...
                $('.subTotalValue').text(totalprice.toLocaleString(undefined, {minimumFractionDigits: 2}));
            });
    }
